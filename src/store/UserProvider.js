  ...
  if (action.type === 'GETUSERINFO') {
    return {
      ...
      userInformation: {
        ...
        codeName: action.payload.userInformation[1],
  ...
  if (action.type === 'GETOWNERDETAILS') {
    return {
      ...
      appOwnerDetails: {
        ...
        codeName: action.appOwnerDetails[1],
      },
    }
  }
...
const UserProvider = (props) => {
  ...
  const getUserInformationHandler = async (
    ...
    try {
      ...
      console.log('getUserInfoHandler error: ', error)
    }
  }
  ...
  const loadUserBalanceHandler = async (contract, account) => {
    try {
      ...
      console.log('loaduserbalancehandler error: ', error)
    }
  }
  ...
  const loadWhitelistHandler = async (contract) => {
    try {
      ...
      console.log('LoadWhitelistHandler Error: ', error)
    }
  }
