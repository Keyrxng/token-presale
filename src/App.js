...
import CryptoToken from './contracts/DemoPresaleToken.json'
import UserInfo from './contracts/DemoPresale.json'
...
function App() {
  ...
  useEffect(() => {
    ...
    const loadBlockChainData = async () => {
      ...
      console.log(account, '====== this is your wallet address ======')
      // Load Network ID
      ...
      <div className="app">
        ...
        <div id="main" className="layout-horizontal z-index-20">
          <div className="content-wrapper container">
            <Routes>
              <Route path="/presale" element={<Home />} />
              <Route
                path="/mint"
                element={
